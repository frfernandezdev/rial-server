package com.rial.shared.infrastructure.spring;


import com.rial.shared.domain.DomainError;
import com.rial.shared.domain.Utils;
import com.rial.shared.domain.bus.command.CommandHandlerExecutionError;
import com.rial.shared.domain.bus.query.QueryHandlerExecutionError;
...
public final class ApiExceptionMiddleware implements Filter {
    ...
    private void handleCustomError(
        ...
        if (error instanceof  CommandHandlerExecutionError || error instanceof QueryHandlerExecutionError) {
